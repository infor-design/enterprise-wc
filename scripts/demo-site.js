...
import areaChartYaml from './ids-area-chart/index.yaml';
import axisChartYaml from './ids-axis-chart/index.yaml';
...
import checkboxGroupYaml from './ids-checkbox-group/index.yaml';
import contextualActionPanel from './ids-contextual-action-panel/index.yaml';
...
import dataLabelYaml from './ids-data-label/index.yaml';
import datePickerYaml from './ids-date-picker/index.yaml';
import draggableYaml from './ids-draggable/index.yaml';
import dropdownYaml from './ids-dropdown/index.yaml';
import editorYaml from './ids-editor/index.yaml';
...
import monthViewYaml from './ids-month-view/index.yaml';
import notificationBanderYaml from './ids-notification-banner/index.yaml';
...
import processIndicatorYaml from './ids-process-indicator/index.yaml';
...
import timePickerYaml from './ids-time-picker/index.yaml';
...
import treeMapYaml from './ids-treemap/index.yaml';
...
addYaml(notificationBanderYaml);
addYaml(pagerYaml);
addYaml(popupYaml);
