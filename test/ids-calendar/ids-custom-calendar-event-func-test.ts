...
import IdsCustomCalendarEvent from '../../src/components/ids-calendar/ids-custom-calendar-event';
...
describe('IdsCustomCalendarEvent Component', () => {
  const name = 'ids-custom-calendar-event';
  ...
  beforeEach(() => {
    calendarEvent = new IdsCustomCalendarEvent();
  ...
  it('should render', () => {
    ...
    expect(document.querySelector('ids-custom-calendar-event')).toBeDefined();
