...
describe('Ids Hyperlink e2e Tests', () => {
  ...
  it('should not have visual regressions in new light theme (percy)', async () => {
    ...
    await pageSnapshot(page, 'ids-hyperlink-new-light');
  });
  ...
  it('should not have visual regressions in standalone css', async () => {
    ...
    await pageSnapshot(page, 'ids-hyperlink-standalone-css', { widths: [1280] });
  });
  ...
  it.skip('should not have visual regressions in new dark theme (percy)', async () => {
    ...
    await pageSnapshot(page, 'ids-hyperlink-new-dark');
  });
  ...
  it.skip('should not have visual regressions in new contrast theme (percy)', async () => {
    ...
    await pageSnapshot(page, 'ids-hyperlink-new-contrast');
  });
});
