...
test.describe('IdsListView tests', () => {
  ...
  test.describe('event tests', () => {
    test('should fire click event on single select', async ({ page }) => {
    ...
    test('should fire selected event on single select', async ({ page }) => {
      await page.goto('/ids-list-view/selectable-single.html');
      const noOfCalls = await page.evaluate(() => {
        let calls = 0;
        const comp = document.querySelector<IdsListView>('ids-list-view');
    ...
    test('should fire click event on multiple select', async ({ page }) => {
