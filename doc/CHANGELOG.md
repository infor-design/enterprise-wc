...
- `[General]` Fixed to angular where attributes property binding was not work properly for ids-menu-button, ids-pager, ids-text, ids-toolbar. ([#941](https://github.com/infor-design/enterprise-wc/issues/941))
