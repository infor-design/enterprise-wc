const messages = {
  ...
  ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Selectați o culoare personalizată', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Faceți clic pentru a deschide Selector culori', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Mai devreme decât sau până la', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Faceți clic pentru a deschide Selector oră', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
