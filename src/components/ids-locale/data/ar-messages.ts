const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'تخطيط المنطقة', comment: 'A chart type' },
  ...
  ColorPickerSelection: { id: 'ColorPickerSelection', value: 'اختيار لون مخصص', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'انقر لفتح منتقي الألوان', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'قبل أو حتى', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'أبريل', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'أغسطس', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'ديسمبر', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'يناير', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'يوليو', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'يونيو', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'مارس', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'مايو', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'نوفمبر', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'أكتوبر', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'سبتمبر', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  RecordSelected: { id: 'RecordSelected', value: 'السجلات المحددة "{0}"', comment: 'Text showing current total of record selected' },
  RecordsSelected: { id: 'RecordsSelected', value: 'السجلات المحددة "{0}"', comment: 'Text showing current total of records selected' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'سحب وإفلات أو <span class="hyperlink">Select Files</span> لإجراء التحميل' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'انقر لفتح منتقي الوقت', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
