const messages = {
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Korábbi, mint vagy Amíg', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  RecordsSelected: { id: 'RecordsSelected', value: '{0} Rekordok kiválasztva', comment: 'Text showing current total of records selected' },
  ...
  StartsWith: { id: 'StartsWith', value: 'Ezzel kezdődik', comment: 'for condition filtering' },
