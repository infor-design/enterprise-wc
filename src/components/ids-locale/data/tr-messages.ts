const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'Alan Grafik', comment: 'A chart type' },
  ...
  ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Özel Bir Renk Seç', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Renk Seçiciyi Açmak için tıklayın', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ...
  DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Tarih Seçici Tetikleyici', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Daha Önce veya Buna Kadar', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Arama Tetikleyici', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
  ...
  MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'nisan', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'ağustos', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'aralık', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'ocak', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'temmuz', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'haziran', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'mart', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'mayıs', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'kasım', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'ekim', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'eylül', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Yüklemek İçin Sürükleyip Bırakın veya <süre sınıfı="köprü">Dosyaları Seç</süre>' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Saat Seçiciyi Açmak için tıklayın', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
