const messages = {
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Saat Seçici Tetikleyici', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
