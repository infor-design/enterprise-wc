const messages = {
  ...
  LessThan: { id: 'LessThan', value: 'Menšie ako', comment: 'Less Than in icons for filtering' },
  ...
  PreviousPage: { id: 'PreviousPage', value: 'Predchádzajúca strana', comment: 'Move to next item on Pager component' },
