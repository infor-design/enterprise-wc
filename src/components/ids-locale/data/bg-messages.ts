const messages = {
  ...
  EndsWith: { id: 'EndsWith', value: 'Завършва с', comment: 'for condition filtering' },
  ...
  PreviousRecord: { id: 'PreviousRecord', value: 'Предишен запис', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
