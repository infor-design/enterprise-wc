const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'Vlakdiagram', comment: 'A chart type' },
  ...
  EventType: { id: 'EventType', value: 'Type gebeurtenis', comment: 'The kind of event, for action vacation or sick time' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Slepen en neerzetten of <span class="hyperlink">bestanden selecteren</span> om te uploaden' },
