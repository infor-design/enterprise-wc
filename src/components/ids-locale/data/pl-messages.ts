const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'Wykres warstwowy', comment: 'A chart type' },
  ...
  ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Wybierz kolor niestandardowy', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Kliknij, aby otworzyć selektor kolorów', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ...
  DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Wyzwalacz selektora daty', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Wcześniej niż lub do', comment: 'Earlier Than Or Equals in icons for filtering' },
  EarlyThan: { id: 'EarlyThan', value: 'Wcześniej niż', comment: 'Early Than in icons for filtering' },
  ...
  ExportToCsv: { id: 'ExportToCsv', value: 'Eksportuj do CSV', comment: 'Export To CSV menu option in datagrid' },
  ...
  LaterThan: { id: 'LaterThan', value: 'Później niż', comment: 'Later Than in icons for filtering' },
  ...
  LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Wyzwalacz wyszukiwania', comment: 'Used in accessible labels to describe a lookup field\'s trigger button to assistive technology' },
  ...
  MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'kwiecień', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'sierpień', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'grudzień', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'styczeń', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'lipiec', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'czerwiec', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'marzec', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'listopad', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'październik', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'wrzesień', comment: 'Month in Wide form lower case  - in some languages/situations this must be lower case (but not english)' },
  ...
  NotSelected: { id: 'NotSelected', value: 'Nie zaznaczono', comment: 'Not Selected in icons for filtering' },
  ...
  SelectAll: { id: 'SelectAll', value: 'Wybierz wszystko', comment: 'describes the action of selecting all items available in a list' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Przeciągnij i upuść lub <span class="hyperlink">Wybierz pliki</span>, aby przekazać' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Kliknij, aby otworzyć selektor godzin', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
  ...
  UpComingEvents: { id: 'UpComingEvents', value: 'Nadchodzące wydarzenia', comment: 'List of upcoming calendar events' },
  ...
  ViewSource: { id: 'ViewSource', value: 'Widok źródła', comment: 'Toggle between the source view and visual view' },
