const messages = {
  ...
  GreaterThan: { id: 'GreaterThan', value: 'Større enn', comment: 'Greater Than in icons for filtering' },
  ...
  RecordSelected: { id: 'RecordSelected', value: '{0} oppføring valgt', comment: 'Text showing current total of record selected' },
  RecordsSelected: { id: 'RecordsSelected', value: '{0} oppføringer valgt', comment: 'Text showing current total of records selected' },
