const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'Graphique en aires', comment: 'A chart type' },
  ...
  ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Choisissez une couleur personnalisée', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Cliquez pour ouvrir le sélecteur de couleurs', comment: 'Used in accessible labels to describe a color picker field\'s trigger button to assistive technology' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Avant ou jusqu\'à', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  LaterOrOn: { id: 'LaterOrOn', value: 'Apres ou le', comment: 'Later Than Or Equals in icons for filtering' },
  ...
  Small: { id: 'Small', value: 'Petite', comment: 'A more small grid setting for rows and sizes. NOTE: Please change french to Petite (Masculine form)' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Glisser déplacer ou <span class="hyperlink">sélectionner les fichiers</span> à charger' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Cliquez pour ouvrir le sélecteur d\'heure', comment: 'Used in accessible labels to describe a time picker field\'s trigger button to assistive technology' },
