const messages = {
  ...
  AreaChart: { id: 'AreaChart', value: 'Diagram Area', comment: 'A chart type' },
  ...
  EarlyOrUntil: { id: 'EarlyOrUntil', value: 'Lebih Cepat Dari Atau Sampai', comment: 'Earlier Than Or Equals in icons for filtering' },
  ...
  InsertHyperlink: { id: 'InsertHyperlink', value: 'Sisipkan Tautan', comment: 'Insert a hyperlink (synonymous with link or anchor tag) into an editor. Please recheck this as it was renamed from anchor.' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Seret dan Jatuhkan atau <span class="hyperlink">Pilih File</span> untuk Mengunggah' },
