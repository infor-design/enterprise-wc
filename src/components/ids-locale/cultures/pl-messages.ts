const messages = {
  ...
  English: { id: 'English', value: 'Angielski (Australia)', comment: 'Language name for English' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Wyzwalacz selektora godziny', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
