const messages = {
  ...
  English: { id: 'English', value: 'Angličtina (Austrália)', comment: 'Language name for English' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Presuňte alebo <span class="hyperlink">vyberte súbory</span>, ktoré chcete nahrať' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Spúšťač výberu časov', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
