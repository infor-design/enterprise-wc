const messages = {
  ...
  InsertHyperlink: { id: 'InsertHyperlink', value: 'Vložiť hypertextové prepojenie', comment: 'Insert a hyperlink in an editor' },
