const messages = {
  ...
  CollapseAppTray: { id: 'CollapseAppTray', value: 'Toepassingsbalk samenvouwen', comment: 'Collapse App Tray tooltip' },
  ...
  DaysOverdue: { id: 'DaysOverdue', value: '{0} verstreken dagen', comment: 'For a task /date UI' },
  ...
  InsertHyperlink: { id: 'InsertHyperlink', value: 'Hyperlink invoegen', comment: 'Insert a hyperlink in an editor' },
  ...
  OrderedList: { id: 'OrderedList', value: 'Opsommingslijst invoegen/verwijderen', comment: 'Insert an Ordered list in the editor' },
  ...
  SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Sleep om aan te passen', comment: 'Drags the splitter handle' },
  ...
  TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Slepen en neerzetten of <span class="hyperlink">bestanden selecteren</span> om te uploaden', comment: 'text for drop area with browse for advanced fileupload' },
  ...
  TimepickerTriggerButton: { id: 'TimepickerTriggerButton', value: 'Tijdkiezer-trigger', comment: 'Used in accessible labels to describe a date picker field\'s trigger button to assistive technology' },
