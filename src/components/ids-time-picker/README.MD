...
```html
<ids-time-picker label="Time Picker"></ids-time-picker>
```
...
- 3.x: Timepicker have all new markup and classes.
- 4.x: Timepicker have all new markup and classes for web components.
