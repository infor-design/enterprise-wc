...
const lookupAuto: Element | any = document.querySelector('#lookup-6');
const autocomplete: Element | any = lookupAuto.shadowRoot?.querySelector('ids-trigger-field');
