const messages = {
  ...
  ChangeSelection: { id: 'ChangeSelection', value: 'Gebruik de pijltjestoetsen om het geselecteerde artikel te wijzigen.', comment: 'Audible Text for drop down list help' },
  ...
  SplitterCollapseButton: { id: 'SplitterCollapseButton', value: 'Splitser invouwen', comment: 'Action to move the position of splitter either to left or right' },
