      ...
      conversions: {
        ...
        toGregorian: function(hyear, hmonth, hday) { // eslint-disable-line
          ...
          for (let i = 0; i < hmonth; i++) {
            days += 29 + (monthLength & 1); //eslint-disable-line
            monthLength >>= 1; //eslint-disable-line
          }
        ...
        fromGregorian: function(gdate) { // eslint-disable-line
          ...
          let daysInMonth = 29 + (monthLength & 1); //eslint-disable-line
          while (days >= daysInMonth) {
            days -= daysInMonth;
            monthLength >>= 1; //eslint-disable-line
            daysInMonth = 29 + (monthLength & 1); //eslint-disable-line
            hmonth++;
          }
