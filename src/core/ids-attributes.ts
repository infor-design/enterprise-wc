...
export const attributes = {
  ...
  SAVES_ACTIVE_PAGE: 'saves-active-page',
  SAVES_COLUMNS: 'saves-columns',
  SAVES_FILTER: 'saves-filter',
  SAVES_PAGE_SIZE: 'saves-page-size',
  SAVES_ROW_HEIGHT: 'saves-row-height',
  SAVES_SORT_ORDER: 'saves-sort-order',
  SAVES_USER_SETTINGS: 'saves-user-settings',
